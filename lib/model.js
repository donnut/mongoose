...
Model.prototype.save = function (fn) {
  ...
  // Validate
  var p0 = new Promise;
  self.validate(p0.resolve.bind(p0));
...
Model.discriminator = function discriminator (name, schema) {
  ...
  (function mergeSchemas(schema, baseSchema) {
    ...
    (function validateOptions(a, b) {
      ...
      delete a.toJSON;
      delete a.toObject;
      delete a.discriminatorKey;
      delete b.toJSON;
      delete b.toObject;
      delete b.discriminatorKey;

      if (!utils.deepEqual(a, b)) {
        throw new Error("Discriminator options are not customizable (except toJSON & toObject & discriminatorKey)");
      }
